...
| **2.0.1** | AutoJS Pro 9.3.11（第1代API） | 移除微信支持，专注钉钉平台，微信加了防自动化，后续换方案加回来 |
| **2.0.2** | AutoJS Pro 9.3.11（第1代API） | 🚀 流程优化，性能提升 6.6 倍，响应速度更快，详见 [OPTIMIZATION.md](OPTIMIZATION.md) |
